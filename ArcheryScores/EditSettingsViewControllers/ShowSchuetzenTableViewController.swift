//
//  ShowSchuetzenTableViewController.swift
//  ArcheryScores
//
...
class ShowSchuetzenTableViewController: UITableViewController {
    ...
    {
        schuetzen += ["beispiel@email.com", "test.test@gmail.de", "max.mustermann@web.de", "test@mail.com"]
    }
